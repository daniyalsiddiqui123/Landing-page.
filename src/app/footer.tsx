...
export default function Footer() {
    return (
        <div className="bg-blue-950 h-screen sm:h-56 md:h-72 2xl:h-[600px] text-white">
            ...
            <div>
                <div className="flex text-left space-x-10 text-2xl p-10 my-20 lg: 2xl:text-3xl text-white">
